...
const FeedbackCard = ({
  ...
  company,
  image,
}: TestimonialParams & { index: number }) => (
  <motion.div
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      <div className={`${styles.paddingX} -mt-20 pt-14 flex flex-wrap gap-7`}>
        {testimonials.map((testimonial: TestimonialParams, index: number) => (
